...
class TileMap < BasicGameObject
  ...
  def initialize options
    ...
    Tile.const_set("TILE_WIDTH",@tile_width)
    Tile.const_set("TILE_HEIGHT",@tile_height)
  ...
  class TileSet
    ...
    def initialize options
      ...
      sets.each do |s|
        ...
        s[:tiles] =Gosu::Image.load_tiles($window,ts_path,Tile.const_get('TILE_WIDTH'),Tile.const_get('TILE_HEIGHT'),true)
      end
